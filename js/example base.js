...
var worldetch_example_base;
(function (worldetch_example_base) {
    async function init() {
        console.log(' init ');
        worldetch__.init({});
        glob.sample =
    ...
    worldetch_example_base.init = init;
    ...
    worldetch_example_base.make_testing_chamber = make_testing_chamber;
    ...
    worldetch_example_base.purge_remake = purge_remake;
    function step() {
    ...
    worldetch_example_base.step = step;
    function keys() {
        if (app.key('-') == 1) {
...
})(worldetch_example_base || (worldetch_example_base = {}));
